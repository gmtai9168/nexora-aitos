...
- `/` **Command Center** (PAGE 01 — ตามสเปกเต็ม)
- `/markets` **ข้อมูลเหรียญ** — คริปโต / หุ้นไทย / หุ้นต่างประเทศ, ค้นหา, จัดเรียง, รายการโปรด, กราฟรายตัว
- `/ai-network` **เครือข่าย AI 50**
- `/portfolio` **พอร์ตการลงทุน**

เมนูที่เหลือ (`/execution` `/strategies` `/backtest` `/ai-learning` `/risk` `/history` `/alerts` `/settings`)
มีโครงหน้าและรายการสิ่งที่จะทำแล้ว
